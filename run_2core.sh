...
(./bin/${binary} -warmup_instructions 50000000 -simulation_instructions 50000000 -traces ${TRACE_DIR1}/${trace1} ${TRACE_DIR2}/${trace2}) > results/mix-${num1}-${num2}-${binary}.txt & #change the name of the folder as required
